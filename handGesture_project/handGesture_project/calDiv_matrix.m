...
ext_of_interest = '.bmp';
n_sample_display = 3; % number of samples you want to show for each posture
...
save divmatrixwholedataset Dcs_matrix Dkl_MC_matrix
%% Fancy plot
% ==== be careful when the number of samples is big, the icon will shrink
% to small dot....
