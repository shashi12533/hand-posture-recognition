...
samples = [25 150 250]; %[10 25 50 75 100 125 150 175 200 225 250]; This for stochastic Dkl only
...
axis([0 0.8 0 100]); xlabel('average time (sec)'); ylabel('average accuracy (%)');
legend('D_{KL}','D_{CS}');
